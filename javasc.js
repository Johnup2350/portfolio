...
function motraseA() {
    ...
    p.textContent = "Técnico de Suporte de TI, Cursando Ciência da Computação, estou atuando com computação e Infraestrutura de Rede e Programação. Aspirando em crescimento na minha carreira estou em busca de oportunidades ofereço suporte e comodidade realizando atendimento remoto e presencial. Possuindo experiência em configuração de Hardware/softwares, eletrônico “de conserto a montagem de computador”, tenho conhecimento em rotina de Backup, Itil, Experiência em sistemas operacionais. Sei HTML/CSS/JS, Java, Python design/Gráfico e 3D, Falo Francês, inglês “intermediário” com CNH AD-EAR, Trabalhei para inúmeras pessoas da comunidade local e empresas como Farma Brasília, Pedras do rio, Odontoclinic, Atelier da Thereza, Diva salgados etc... em vista disso ganhei boas avaliações que consequentemente me ajudou a Evoluir e Melhorar. Atualmente trabalhando como Técnico de Suporte Local na CTC uma Grande Empresa de Tecnologia Transformadora."
}
function motraseC() {
    const aside = document.getElementById("aside_R");
    aside.classList.toggle("oculto");
